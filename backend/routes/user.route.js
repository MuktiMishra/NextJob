...
import { login, logout, register, updateProfile, getDashboardData } from '../controllers/user.controller.js';
...
userRouter.route('/getdashboarddata').get(isAuthenticated, getDashboardData)
