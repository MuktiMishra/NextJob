        ...
        <div className="min-h-screen bg-[#F6F7F8]">
            <div className="max-w-7xl flex justify-center gap-x-16 mx-auto p-6">
                <div className=" ">
                    ...
                    <div className="mt-8 bg-white rounded-t-xl p-8">
                        <p className="text-2xl text-black tracking-tight">Personal Information</p>
                        <div className="flex justify-between mt-4 items-center">
                            <div className="flex flex-col gap-y-2">
                                <label className="text-black">Full Name</label>
                                <input disabled={true} value={user.fullname} className="pr-20 pl-2 rounded-lg cursor-not-allowed py-4 border-gray-300 border text-gray-500"/>
                            </div>
                            <div className="flex flex-col gap-y-2">
                                <label className="text-black">Email Address</label>
                                <input disabled={true} value={user.email} className="pr-20 pl-2 rounded-lg cursor-not-allowed py-4 border-gray-300 border text-gray-500"/>
                            </div>
                        </div>
                    ...
                    <div className="h-24 p-4 flex items-center justfiy-around bg-[#F9FAFC] rounded-b-xl ">
                        <p className="text-gray-400">Application will be sent to the recruiter and status will be 'PENDING'</p>
                        <button onClick={handleApply} className="px-8 whitespace-nowrap py-4 hover:opacity-80 transition-opacity duration-150 ease-in bg-blue-600 text-white rounded-xl">Apply Job</button>
                    </div> 
                </div>
                <div className="w-72 h-fit py-7 px-4 rounded-xl bg-white">
